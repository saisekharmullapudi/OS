...
int compare(IORequest* r1, IORequest* r2)
{
	if(r1->getRespondTime()>r2->getRespondTime())
	{
		return 1;
	}
	else if(r1->getRespondTime()< r2->getRespondTime())
	{
		return 1;
	}
	else{
...
Kernel::Kernel(int argc, char **argv)
{
	...
	todo = new SortedList<IORequest*>(compare);
