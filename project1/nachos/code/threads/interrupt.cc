...
// check any pending interrupts are now ready to fire
	...
	//std::cout<<"Thread execution time expired  "<<kernel->stats->totalTicks<<endl;
	status = oldStatus;
    }
}
...
Interrupt::Schedule(CallBackObj *toCall, int fromNow, IntType type)
{
	...
	if(fromNow<=0)
	{
		//std::cout<<"timer interrutp at "<<fromNow <<endl;
	}
    ASSERT(fromNow > 0);
	std::cout<<"timer interrutp at "<<fromNow <<endl;
...
Interrupt::changeInterrupt(int t)
{
	...
	std::cout<<".................................."<<endl;
	std::cout<<"Timer Interrupt at  "<<kernel->stats->totalTicks+t<<" having qunatum  "<<t<<endl;
	std::cout<<".................................."<<endl;
	pending->Insert(p);
	delete iter;
}
