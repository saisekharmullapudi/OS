...
void Kernel::Initialize() {
	...
	readSemaphoreM = new std::map<std::string, Semaphore*>();
	writeSemaphoreM = new std::map<std::string, Semaphore*>();

	openCount = new std::map<std::string, int>();
	openLock = new std::map<std::string, Lock*>();
	removeLock = new std::map<std::string, Condition*>();
	deleted = new List<std::string>();

	readCount = new std::map<std::string, int>();
...
Kernel::~Kernel() {
	...
	delete removeLock;
	delete deleted;
	delete readSemaphoreM;
	delete writeSemaphoreM;
	delete readCount;
